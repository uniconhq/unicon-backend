...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "submission_problem_id_fkey", "submission", "problem", ["problem_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        "task_result_task_attempt_id_fkey",
        "task_result",
        "task_attempt",
        ["task_attempt_id"],
        ["id"],
...
def downgrade() -> None:
    ...
    op.drop_constraint("task_result_task_attempt_id_fkey", "task_result", type_="foreignkey")
    op.create_foreign_key(
    ...
    op.create_unique_constraint("uq_task_definition_id_id", "task", ["definition_id", "id"])
    op.create_foreign_key(
