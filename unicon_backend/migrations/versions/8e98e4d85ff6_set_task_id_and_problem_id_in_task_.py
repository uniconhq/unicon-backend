"""Set task_id and problem_id in task attempt as composite foreign key

Revision ID: 8e98e4d85ff6
Revises: d2b42a52397a
Create Date: 2024-12-08 19:13:36.341656
...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        "task_attempt_task_id_problem_id_fkey",
        "task_attempt",
        "task",
        ["task_id", "problem_id"],
        ["id", "problem_id"],
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint("task_attempt_task_id_problem_id_fkey", "task_attempt", type_="foreignkey")
    op.drop_constraint("task_pkey", "task", type_="primary")
