...
def update_group(
    ...
    group.members = [user for user in users if user.id in data.members]
    group.supervisors = [user for user in users if user.id in data.supervisors]
